...
public class MonitorBlockingQueueTestRunner : ITestRunner
{
    private readonly MonitorBlockingQueue<int> _blockingQueue = new(1);

    public string Name => "Monitor Blocking Queue";
    public void Run()
    {
    ...
    {
        var data = RandomNumberGenerator.GetInt32(0, 1000);
        while (true)
        {
    ...
    private void ConsumerThread()
    {
        while (true)
        {
            var data = _blockingQueue.Dequeue();
